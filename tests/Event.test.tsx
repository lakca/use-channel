...
it('Event', async () => {
  ...
  await findByText('Parent Receiving Times: 0 0')
  await findByText('SiblingOne Receiving Times: 0 1')
  await findByText('SiblingTwo Receiving Times: 0 1')
  ...
  await findByText('SiblingOne Receiving Times: 1 3')
  await findByText('SiblingTwo Receiving Times: 1 3')
  ...
  await findByText('SiblingOne Receiving Times: 2 5')
  await findByText('SiblingTwo Receiving Times: 2 5')
  ...
  await findByText('SiblingOne Receiving Times: 3 7')
  await findByText('SiblingTwo Receiving Times: 3 7')
  unmount()
})
